            ...
            <div class="flex">
                ...
                <a href="/" class="flex-shrink-0 flex items-center justify-center">
                    {{-- <a href="/"> --}}
                        ...
                        <span class="text-2xl ml-1 font-semibold text-trueGray-800">MiAguacate</span>
                    {{-- </a> --}}
                </a>
                    ...
                    <x-jet-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                                <button class="flex items-center justify-center text-sm border-2 border-transparent rounded-full focus:outline-none focus:border-gray-300 transition">
                                    <span class="text-trueGray-900 px-3">
