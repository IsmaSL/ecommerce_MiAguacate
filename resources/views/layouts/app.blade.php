...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        ...
        <div class="min-h-screen bg-gray-100 relative">
            ...
            <!-- footer -->
            <div class="bg-trueGray-800 w-full absolute -bottom-24 md:-bottom-0 px-5 py-3 flex items-center justify-center">
                <span class="text-white text-xs">Copyright © 2021 JLGP</span>
            </div>
        </div>
        @stack('modals')
