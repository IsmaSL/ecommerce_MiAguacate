...
class OrderController extends Controller
{
    ...
    // Mover a WebhooksController/__invoke cuando esté en producción
    public function pay(Order $order, Request $request){

        $this->authorize('author', $order);

        $payment_id = $request->get('payment_id');
        $response = Http::get("https://api.mercadopago.com/v1/payments/$payment_id" . "?access_token=APP_USR-2182293294680969-092904-012b0cb958fcc23e643b98bdc262c9cd-832396076");
